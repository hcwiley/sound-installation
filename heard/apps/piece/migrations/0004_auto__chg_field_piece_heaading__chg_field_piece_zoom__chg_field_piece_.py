...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.heaading'
        db.alter_column('piece_piece', 'heaading', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Piece.zoom'
        db.alter_column('piece_piece', 'zoom', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Piece.pitch'
        db.alter_column('piece_piece', 'pitch', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Piece.heaading'
        db.alter_column('piece_piece', 'heaading', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Piece.zoom'
        db.alter_column('piece_piece', 'zoom', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Piece.pitch'
        db.alter_column('piece_piece', 'pitch', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'piece.piece': {
            ...
            'heaading': ('django.db.models.fields.FloatField', [], {'default': '180.0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
