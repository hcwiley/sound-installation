...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Piece.heading'
        db.add_column('piece_piece', 'heading', self.gf('django.db.models.fields.FloatField')(default=180.0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Piece.heaading'
        db.add_column('piece_piece', 'heaading', self.gf('django.db.models.fields.FloatField')(default=180.0), keep_default=False)

        # Deleting field 'Piece.heading'
        db.delete_column('piece_piece', 'heading')
