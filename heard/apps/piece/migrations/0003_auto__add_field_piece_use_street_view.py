...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Piece.use_street_view'
        db.add_column('piece_piece', 'use_street_view', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Piece.use_street_view'
        db.delete_column('piece_piece', 'use_street_view')
