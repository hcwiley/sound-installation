...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Piece.activation_code'
        db.add_column('piece_piece', 'activation_code', self.gf('django.db.models.fields.CharField')(default='000', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Piece.activation_code'
        db.delete_column('piece_piece', 'activation_code')
